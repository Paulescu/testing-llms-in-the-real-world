...
def run():
    ...
    # logger.info('Validating the wrapped model and dataset...')
    # logger.info(giskard_model.predict(giskard_dataset).prediction)
    # logger.info('Validation done!')

    # # scan model for vulnerabilities
    # logger.info('Scanning model for vulnerabilities...')
    # results = scan(giskard_model, giskard_dataset, only="hallucination")

    # # generate test suite from scan results
    # logger.info('Generating test suite from scan results...')
    # test_suite = results.generate_test_suite("Test suite generated by scan")
    # test_suite.run()

    # # push test suite to our Giskard server
    # logger.info('Pushing test suite to Giskard server...')
